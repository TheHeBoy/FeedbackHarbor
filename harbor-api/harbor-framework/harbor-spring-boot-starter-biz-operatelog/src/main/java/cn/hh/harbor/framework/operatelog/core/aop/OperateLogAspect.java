package cn.hh.harbor.framework.operatelog.core.aop;
...
import cn.hh.harbor.framework.operatelog.core.service.OperateLog;
...
import static cn.hh.harbor.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        cn.hh.harbor.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                cn.hh.harbor.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         cn.hh.harbor.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           cn.hh.harbor.framework.operatelog.core.annotations.OperateLog operateLog,
