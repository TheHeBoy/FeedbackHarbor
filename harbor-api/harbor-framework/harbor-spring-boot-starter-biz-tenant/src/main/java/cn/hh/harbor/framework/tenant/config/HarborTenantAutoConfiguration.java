package cn.hh.harbor.framework.tenant.config;
...
import cn.hh.harbor.framework.tenant.core.aop.TenantIgnoreAspect;
...
import cn.hh.harbor.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.hh.harbor.framework.tenant.core.web.TenantContextWebFilter;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "harbor.tenant", value = "enable", matchIfMissing = true) // 允许使用 harbor.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class HarborTenantAutoConfiguration {
