package cn.hh.harbor.framework.desensitize.core;

import cn.hh.harbor.framework.common.util.json.JsonUtils;
import cn.hh.harbor.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.hh.harbor.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.hh.harbor.framework.desensitize.core.annotation.Address;
import cn.hh.harbor.framework.desensitize.core.slider.annotation.BankCardDesensitize;
import cn.hh.harbor.framework.desensitize.core.slider.annotation.CarLicenseDesensitize;
import cn.hh.harbor.framework.desensitize.core.slider.annotation.ChineseNameDesensitize;
import cn.hh.harbor.framework.desensitize.core.slider.annotation.FixedPhoneDesensitize;
import cn.hh.harbor.framework.desensitize.core.slider.annotation.IdCardDesensitize;
import cn.hh.harbor.framework.desensitize.core.slider.annotation.PasswordDesensitize;
import cn.hh.harbor.framework.desensitize.core.slider.annotation.MobileDesensitize;
