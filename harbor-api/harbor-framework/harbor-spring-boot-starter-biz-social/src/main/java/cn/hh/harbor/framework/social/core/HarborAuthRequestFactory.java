package cn.hh.harbor.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import cn.hh.harbor.framework.social.core.enums.AuthExtendSource;
import cn.hh.harbor.framework.social.core.request.AuthWeChatMiniAppRequest;
 ...
 * @date 2021-10-31
 */
public class HarborAuthRequestFactory extends AuthRequestFactory {
    ...
    public HarborAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
