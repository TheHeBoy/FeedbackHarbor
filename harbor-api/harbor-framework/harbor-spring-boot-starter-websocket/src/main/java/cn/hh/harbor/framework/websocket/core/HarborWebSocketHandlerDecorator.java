package cn.hh.harbor.framework.websocket.core;
...
public class HarborWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public HarborWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
