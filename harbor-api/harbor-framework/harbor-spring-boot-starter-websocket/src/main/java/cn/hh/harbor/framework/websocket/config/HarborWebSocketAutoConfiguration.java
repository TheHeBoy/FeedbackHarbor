 ...
 */
@AutoConfiguration
// 允许使用 harbor.websocket.enable=false 禁用websocket
@ConditionalOnProperty(prefix = "harbor.websocket", value = "enable", matchIfMissing = true)
@EnableConfigurationProperties(WebSocketProperties.class)
public class HarborWebSocketAutoConfiguration {
    @Bean
