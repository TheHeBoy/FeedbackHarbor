...
import cn.hh.harbor.framework.tracer.core.aop.BizTraceAspect;
import cn.hh.harbor.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "harbor.tracer", value = "enable", matchIfMissing = true)
public class HarborTracerAutoConfiguration {
