...
import cn.hh.harbor.framework.mq.core.RedisMQTemplate;
import cn.hh.harbor.framework.mq.core.interceptor.RedisMessageInterceptor;
import cn.hh.harbor.framework.mq.core.pubsub.AbstractChannelMessageListener;
import cn.hh.harbor.framework.mq.core.stream.AbstractStreamMessageListener;
import cn.hh.harbor.framework.mq.job.RedisPendingMessageResendJob;
...
public class HarborMQAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "harbor.mq.redis.pubsub", value = "enable", matchIfMissing = true) // 允许使用 harbor.mq.redis.pubsub.enable=false 禁用多租户
    ...
    @ConditionalOnProperty(prefix = "harbor.mq.redis.stream", value = "enable", matchIfMissing = true) // 允许使用 harbor.mq.redis.stream.enable=false 禁用多租户
