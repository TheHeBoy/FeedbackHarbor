...
import cn.hh.harbor.framework.test.core.ut.BaseDbUnitTest;
import cn.hh.harbor.module.infra.api.logger.dto.ApiErrorLogCreateReqDTO;
import cn.hh.harbor.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogExportReqVO;
import cn.hh.harbor.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.hh.harbor.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.hh.harbor.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.hh.harbor.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.hh.harbor.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static cn.hh.harbor.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.hh.harbor.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.hh.harbor.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.hh.harbor.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.hh.harbor.framework.test.core.util.RandomUtils.randomLongId;
import static cn.hh.harbor.framework.test.core.util.RandomUtils.randomPojo;
import static cn.hh.harbor.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.hh.harbor.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("harbor-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("harbor-test");
