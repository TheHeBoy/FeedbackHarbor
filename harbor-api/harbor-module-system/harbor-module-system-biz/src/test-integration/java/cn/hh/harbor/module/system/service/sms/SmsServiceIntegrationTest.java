...
import cn.hh.harbor.framework.sms.config.HarborSmsAutoConfiguration;
import cn.hh.harbor.module.system.test.BaseDbAndRedisIntegrationTest;
import cn.hh.harbor.module.system.mq.consumer.sms.SmsSendConsumer;
import cn.hh.harbor.module.system.mq.producer.sms.SmsProducer;
import cn.hh.harbor.module.system.service.user.AdminUserService;
...
// TODO @芋艿：需要迁移
@Import({HarborSmsAutoConfiguration.class,
