...
import cn.hh.harbor.module.system.controller.admin.tenant.vo.packages.*;
import cn.hh.harbor.module.system.convert.tenant.TenantPackageConvert;
import cn.hh.harbor.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.hh.harbor.module.system.service.tenant.TenantPackageService;
...
public class TenantPackageController {
    ...
    @Operation(summary = "获取租户套餐精简信息列表", description = "用于给租户选择套餐")
    public CommonResult<List<TenantPackageSimpleRespVO>> getTenantPackageList() {
        // 获得角色列表，只要开启状态的
        List<TenantPackageDO> list = tenantPackageService.getTenantPackageList();
        return success(TenantPackageConvert.INSTANCE.convertList2(list));
    }
}
