...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.hh.boot";
    private static final String ARTIFACT_ID = "harbor";
    private static final String PACKAGE_NAME = "cn.hh.harbor";
    private static final String TITLE = "反馈港管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.hh.boot";
        String artifactIdNew = "harbor";
        String packageNameNew = "cn.hh.harbor";
        String titleNew = "反馈港管理系统";
    ...
    private static Collection<File> listFiles(String projectBaseDir) {
        ...
        files = files.stream()
                .filter(file -> !file.getPath().contains(separator + "target" + separator)
                        ...
                        && !file.getPath().contains(separator + "static/dist" + separator)
