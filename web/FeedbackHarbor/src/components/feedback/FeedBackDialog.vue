  ...
  <el-dialog v-model="isShow" width="700" title="反馈内容" :destroy-on-close="true">
    <el-form ref="ruleFormRef" hide-required-asterisk label-position="top" :model="modelData">
      ...
      <el-form-item label="反馈内容" prop="content">
        <InputBox ref="commentRef" placeholder="输入反馈内容" alwaysShow content-btn="提交反馈" :min-height="150" />
      </el-form-item>
    </el-form>
  </el-dialog>
</template>
...
import InputBox from '~/components/comment/src/tools/input-box.vue';
import { InjectInputBox, InjectInputBoxApi, SubmitParam2Api } from '~/components/comment/key';
import { InjectionEmojiApi } from '~/components/emoji';
