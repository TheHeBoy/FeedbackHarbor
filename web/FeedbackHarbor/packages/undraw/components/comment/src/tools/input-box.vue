<template>
  <div v-click-outside:[popperRef]="onClickOutside" class="comment-box">
    <u-editor ref="editorRef" v-model="content" :class="{ 'input-active': action }" :placeholder="props.placeholder"
      :min-height="props.minHeight" :img-list="imgList" @focus="onFocus" @input="input" @submit="onSubmit"></u-editor>
    <Transition name="fade">
      <div v-if="alwaysShow || action" class="action-box">
        ...
        <el-button type="primary" :disabled="props.contentBtnDisable || disabled" @click="onSubmit">
          {{ props.contentBtn }}
        </el-button>
      </div>
    </Transition>
...
interface Props {
  ...
  contentBtnDisable?: boolean
}

const props = withDefaults(defineProps<Props>(), {
  contentBtnDisable: false
})
